...
# ** 项目配置区 **
#    输出文件名称
TARGET_NAME     = IOBusinessWEB
#    输出文件类型
TARGET_TYPE     = ${TARGET_TYPE_DLL}
#    输出文件后缀 [自动判别]
TARGET_NAME_EXT =
#    安装位置
INSTALL_PATH    = /usr/local/IOBusinessWEB
...
TARGET_LIBS = -lstdc++ -lwebsockets -lmodule -lmodel -lioevent
# 链接标志
...
IOEngineLWS: ./out/main.o
	cc -o bin/arguments ./out/main.o -lIOEngineLWS ${TARGET_LIBS}
